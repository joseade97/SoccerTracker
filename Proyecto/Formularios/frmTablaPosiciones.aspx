...
<%@ Page Language="C#" MasterPageFile="~/Formularios/ProyectoMaster.Master" AutoEventWireup="true" CodeBehind="frmTablaPosiciones.aspx.cs" Inherits="Proyecto.Formularios.frmTablaPosiciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="frm1" runat="server" class="text-center">
        ...
        <asp:DropDownList ID="ddlCampeonatos" runat="server">
        </asp:DropDownList> <asp:Button Text="Listar" ID="btnSubmit" class="btn btn-alter btn-s" runat="server" OnClick="btnSubmit_Click" />

        <rsweb:ReportViewer ID="rpvPosiciones" runat="server" Width="100%" Height="800px">
        </rsweb:ReportViewer>
    </form>
</asp:Content>
